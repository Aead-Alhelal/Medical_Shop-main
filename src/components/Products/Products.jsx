      ...
      <div className="">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto">
          ...
          <p data-aos="fade-up" className="text-sm text-gray-600">
            ...
            healthcare necessities - fast shipping to all governorates
          </p>
        </div>
        {/* Body section */}
        <div>
          ...
          <div className="flex justify-center">
            <Link to="/Details" className="text-center mt-10 cursor-pointer bg-primary text-white py-1 px-5 rounded-md">
              Show more
